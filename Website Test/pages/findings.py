...
layout = html.Div(
    ...
    children=[
        ...
        html.Div(style=CARD_STYLE, children=[
            ...
            html.P("Monthly aggregation reveals long-term trends and periods of rapid change across food groups.")
        ]),
        ...
        html.Div(style=CARD_STYLE, children=[
            ...
            html.P("Distribution differences across food groups indicate which categories have higher volatility.")
        ]),

        html.Div(style=CARD_STYLE, children=[
            html.H3("Overall percent change by food group"),
            dcc.Graph(figure=fig_group_change),
            html.P("This summarizes which food groups increased the most from the first available month to the last.")
        ]),
        ...
        html.Div(style=CARD_STYLE, children=[
            ...
            html.P(
                "This baseline forecast is trained on the full historical window and projects the next 36 months. "
